...
private struct RenameNameField: NSViewRepresentable {
...
private final class CompactRenameField: NSTextField {
    init() {
...
private final class CompactRenameFieldCell: NSTextFieldCell {
